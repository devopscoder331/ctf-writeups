    ...
    <div className="columns is-centered is-vcentered" style={{ minHeight: '60vh', margin: 0 }}>
      <div className="column is-5">
        <div className="box">
          ...
          <h1 className="title is-3 has-text-centered mb-4">Вход в ИКиЗН</h1>
          ...
          <div className="has-text-centered mt-4">
            <p className="mb-2">Нет аккаунта? <Link to="/register" className="has-text-weight-bold">Зарегистрироваться</Link></p>
